 ...
 */
@Slf4j
public class PecadoSentinelInvocationHandler implements InvocationHandler {
	...
	PecadoSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			PecadoSentinelInvocationHandler other = (PecadoSentinelInvocationHandler) obj;
