...
@Aspect
@Component
public class PecadoDataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(me.batizhao.ims.api.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint) {
        ...
        if (null != user) {
            ...
            dataScopeFilter(joinPoint, user, roleData.getData(), controllerDataScope.deptAlias(),
