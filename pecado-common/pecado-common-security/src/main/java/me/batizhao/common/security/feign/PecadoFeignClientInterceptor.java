 ...
 */
@Slf4j
public class PecadoFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
     ...
     */
    public PecadoFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext
